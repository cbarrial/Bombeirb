...
enum compose_type {
	...
	CELL_BOMB1 = CELL_BOMB | BOMB_1,
	CELL_BOMB2 = CELL_BOMB | BOMB_2,
	CELL_BOMB3 = CELL_BOMB | BOMB_3,
	CELL_BOMB4 = CELL_BOMB | BOMB_4,
	CELL_BOMB5 = CELL_BOMB | BOMB_5,
